		...
		<Aux>
			<Container>
				<Segment padded textAlign='center'>
					...
					<p>The intent behind this site was to make vehicle maintenance easier for owners. Have you ever had instances in life
					...
					<div>Joshua Herrera is a technology lover and car enthusiast. He graduated from California State University, Long Beach
					...
					<div>One day, he decided to utilize both of his interests and develop this site, mainly for personal use, as well as a way to learn first hand
					the Reach framework.</div>
				</Segment>
{/*
				<Segment padded textAlign='center'>
					<Header dividing as='h2'>
